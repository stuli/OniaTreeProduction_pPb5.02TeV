...
config.General.requestName = 'Analyzer_Ups1S_pPb_5TeV02'
...
config.JobType.psetName = 'hioniaanalyzer1S_pPb_cfg.py'
config.JobType.outputFiles = ['Upsilon1S_pPb_5TeV02.root']   # match with primary output file in crabCofig

config.section_('Data')
config.Data.inputDataset = '/Upsilon1S_pPb_5p02-Pythia8/stuli-Upsilon1S_pPb_5TeV02-c33dc9ac7d7d0e1f5eed45ebf52f99b5/USER'
