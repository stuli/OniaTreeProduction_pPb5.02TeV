...
config.General.requestName = 'Analyzer_Ups2S_PbP_5TeV02'
...
config.JobType.psetName = 'hioniaanalyzer2S_PbP_cfg.py'
config.JobType.outputFiles = ['Upsilon2S_PbP_5TeV02.root']   # match with primary output file in crabCofig

config.section_('Data')
config.Data.inputDataset = '/Upsilon2S_PbP_5p02-Pythia8/stuli-Upsilon2S_PbP_5TeV02-c33dc9ac7d7d0e1f5eed45ebf52f99b5/USER'   # Get output from skim crab output
