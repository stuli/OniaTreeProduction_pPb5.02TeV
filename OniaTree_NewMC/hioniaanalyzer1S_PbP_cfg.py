...
options.outputFile = "Upsilon1S_PbP_5TeV02.root"
options.secondaryOutputFile = "Ups1S_PbP_DataSet.root"
#options.inputFiles = 'file:Upsilon1S_PbP_SKIM_5TeV02_Pythia8.root'
#options.inputFiles = 'file:Upsilon1S_pa_PbP_SKIM_STARTHI53_V27-v1.root'
options.inputFiles = 'root://cms-xrd-global.cern.ch//store/group/phys_heavyions/stuli/MCpPb5TeV02/Upsilon1S_PbP_5p02-Pythia8/Upsilon1S_PbP_5TeV02/180119_004508/0000/Upsilon1S_pa_PbP_SKIM_STARTHI53_V27-v1_1.root'
...
process.HeavyIonGlobalParameters = cms.PSet(
    ...
    pPbRunFlip = cms.untracked.uint32(1) #Santona: was 211313, should be for data
    )
...
process.hionia = cms.EDAnalyzer('HiOniaAnalyzer',
				...
				#Santona: Including do gen matching. NOPE
