...
config.General.requestName = 'Upsilon1S_PbP_5TeV02'
...
config.JobType.psetName = 'SkimUpsilon1S_PbP_5TeV02_Pythia8.py'
config.JobType.outputFiles = ['Upsilon1S_pa_PbP_SKIM_STARTHI53_V27-v1.root']

config.section_('Data')
config.Data.inputDataset = '/Upsilon1S_PbP_5p02-Pythia8/pAWinter13DR53X-pa_PbP_STARTHI53_V27-v1/GEN-SIM-RECO'
