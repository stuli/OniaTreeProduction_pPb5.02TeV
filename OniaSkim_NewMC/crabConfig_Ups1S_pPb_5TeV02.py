...
config.General.requestName = 'Upsilon1S_pPb_5TeV02'
...
config.JobType.psetName = 'SkimUpsilon1S_pPb_5TeV02_Pythia8.py'
config.JobType.outputFiles = ['Upsilon1S_pa_pPb_SKIM_STARTHI53_V27-v1.root']

config.section_('Data')
config.Data.inputDataset = '/Upsilon1S_pPb_5p02-Pythia8/pAWinter13DR53X-pa_pPb_STARTHI53_V27-v1/GEN-SIM-RECO'
