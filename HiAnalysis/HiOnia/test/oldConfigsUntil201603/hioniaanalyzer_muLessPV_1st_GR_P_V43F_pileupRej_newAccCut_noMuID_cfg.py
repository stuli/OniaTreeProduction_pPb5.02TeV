...
options.outputFile = "pPbData_1st_ntuple_ReprocessedReco-v1_GR_P_V43F_pileupRej_newAccCut_noMuID_v2.root"
...
process.hionia = cms.EDAnalyzer('HiOniaAnalyzer_noMuID',
