...
config.General.requestName = 'Ups3S_tuneD6T_5TeV02'
...
config.JobType.psetName = 'SkimUps3S_tuneD6T_5TeV02.py'
config.JobType.outputFiles = ['Upsilon3S_pa_1st_run_SKIM_STARTHI53_V27-v1.root']
