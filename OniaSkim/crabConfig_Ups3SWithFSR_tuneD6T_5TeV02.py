...
config.General.requestName = 'Ups3SWithFSR_tuneD6T_5TeV02'
...
config.JobType.psetName = 'SkimUps3SWithFSR_tuneD6T_5TeV02.py'
config.JobType.outputFiles = ['Upsilon3SWithFSR_pa_1st_run_SKIM_STARTHI53_V27-v1.root']

config.section_('Data')
config.Data.inputDataset = '/PYTHIA6_Upsilon3S_tuneD6T_5TeV02/HiWinter13-pa_STARTHI53_V27-v1/GEN-SIM-RECO'
