...
config.General.requestName = 'Analyzer_Ups2SWithFSR_tuneD6T_5TeV02'
...
config.JobType.psetName = 'hioniaanalyzer2S_cfg.py'
config.JobType.outputFiles = ['Upsilon2SWithFSR_tuneD6T_5TeV02.root']   # match with primary output file in crabCofig

config.section_('Data')
config.Data.inputDataset = '/PYTHIA6_Upsilon2SWithFSR_tuneD6T_5TeV02/stuli-Ups2SWithFSR_tuneD6T_5TeV02-c33dc9ac7d7d0e1f5eed45ebf52f99b5/USER'   # Get output from skim crab output
